...
pairs = [
    ...
    [
        r"(.*) weather in (.*)?",
        ["Weather in %2 is great, like always", "Pleasant weather here in %2", "Its really hot here in %2",
         "Its very pleasant here in %2", "Sorry, I can't give you real-time information about the weather in %2."]
    ],
    [
